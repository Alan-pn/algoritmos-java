...
public class BreadthFirstSearchTest {
    ...
    public void bfs_founded_node() {
        ...
        final Node node = this.breadthFirstSearch.search(initialState, finalState).orElseThrow(NullPointerException::new);
        assertNotNull(node);
        assertArrayEquals(node.getState(), finalState);
        final List<String> states = getNodeList(node);
    ...
    public void real_test() {
        ...
        final Node node = this.breadthFirstSearch.search(initialState, finalState).orElseThrow(NullPointerException::new);
        printSolution(getNodeList(node), (System.currentTimeMillis()-initialTime));
    }
    ...
    private List<String> getNodeList(final Node node) {
